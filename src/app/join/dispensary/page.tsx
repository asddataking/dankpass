      ...
      <div className="px-6 pt-16 pb-6">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <div className="w-16 h-16 bg-dp-mint/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <MapPin className="w-8 h-8 text-dp-mint" />
            </div>
            <h1 className="text-3xl font-bold text-white mb-2">Dispensary Application</h1>
            <p className="text-white/70">Join our network of cannabis retailers</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
            ...
            {/* Benefits Reminder */}
            <div className="card bg-gradient-to-r from-dp-mint/10 to-dp-lime/10 border-dp-mint/20">
              <h3 className="text-lg font-semibold text-white mb-4">Why Join DankPass?</h3>
              <ul className="space-y-2 text-white/80">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-dp-mint mt-0.5 flex-shrink-0" />
